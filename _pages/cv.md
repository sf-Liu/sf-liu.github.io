        ...
        {% for content in entry.contents %}
          <li class="list-group-item">
            <div class="row align-items-center">
              ...
              <div class="col">
                {% if content.title %}
                  <h6 class="title font-weight-bold mb-1">{{ content.title }}</h6>
                {% endif %}

                {% if content.institution %}
                  <div class="font-italic">{{ content.institution }}</div>
                {% endif %}

                {% if content.location %}
                  <div class="text-muted small">{{ content.location }}</div>
                {% endif %}
              ...
              <!-- Year on the right -->
              {% if content.year %}
              <div class="col-auto text-right" style="font-size:1em; color:gray; background-color:rgba(0,0,0,0.05); padding:4px 10px; border-radius:12px;">
                {{ content.year }}
              </div>
              {% endif %}
          ...
          <li class="list-group-item">
            <div class="row align-items-center">
              <div class="col">
                ...
                {% if content.location %}
                  <div class="text-muted">{{ content.location }}</div>
                {% endif %}
